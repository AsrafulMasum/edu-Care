...
const Footer = () => {
  return (
    <div className="bg-white">
      <footer
        className="footer footer-center pt-10 text-base-content rounded min-h-[60vh]"
        style={{
          // backgroundImage:
          // 'url("https://themeforest.wprealizer.com/html-educoda-preview/educoda/assets/images/shape/hero.png")',
          background: `url("https://themeforest.wprealizer.com/html-educoda-preview/educoda/assets/images/shape/footer-1.png")`,
            ...
            <div className="grid grid-flow-col gap-4">
              <a>
                <svg
                  ...
                  height="24"
                  viewBox="0 0 24 24"
                  className="fill-current cursor-pointer text-secondary-color hover:text-active-color duration-300"
                >
